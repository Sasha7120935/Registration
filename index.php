...
if (!empty($_POST)) {
    ...
    echo "<b>fav color:</b>".$_COOKIE['name'];
    echo "<b>name:</b>".$_COOKIE['surname'];
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container">
    <div class="col-lg-offset-2 col-lg-10">
        <form method="post" class="form-horizontal" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-group">
                <label class="control-label col-lg-2" for="surname"><span class="text-danger">*</span> Surname:</label>
                <div class="col-lg-4">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <?php \Classes\Registration::validateEmail(); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <?php \Classes\Registration::validatePassword(); ?>
            ...
            <div class="form-group">
                <label class="control-label col-lg-2" for="conPwd"><span class="text-danger">*</span> Confirm Password :</label>
                <div class="col-lg-4">
